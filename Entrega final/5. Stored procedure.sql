-- STOCK PROCEDURE 1
-- Se encarga de ordernar la tabla products por la columna que se introduzca en el primer parametro, y luego en el segundo parametro, se ingresa el orden  que se desea (ASC o DESC)
...
-- STOCK PROCEDURE 2
-- Se encarga de insertar un nuevo color dentro de la tabla color, validando que el color que se vaya a ingresar ya no exista en la tabla
DELIMITER $$
